...
<body style="background-color: #303030; font-family: 'Quicksand', sans-serif; position: relative;">
    ...
    <nav class="navbar navbar-dark" style="background-color: #000000;">
        <div class="container-fluid">
            <a class="" href="categorias_cadastradas.html">
                <img src="../img/navbar/back.png" alt="Bootstrap" width="25" height="25">
            </a>
            <a class="navbar-brand" style="margin-right: 0; font-size: 20px;">Alterar Categoria</a>
    ...
    <div class="d-block" style="margin: 5%;">
        <div class="card text-center">
            <div class="card-header">
                <h5 style="margin-top: 2%; margin-bottom: -4%;"><?php echo $stmt[0]['categoria'] ?></h5>
            </div>
            ...
            <div class="card-body">
                <input type="text" id="input-nome-categoria-nova"
                    ...
                    style="background-color: #303030; border-color: #303030;" name="categoria" placeholder="<?php echo $stmt[0]['categoria'] ?>">
                    <input type="text" value="<?php echo $stmt[0]['idcategoria'] ?>" style="margin-top: -3%;"  name="idcategoria" hidden>
